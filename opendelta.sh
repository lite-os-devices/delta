...
BIN_JAVA=java
BIN_MINSIGNAPK=$HOME/src/minsignapk.jar
BIN_XDELTA=$HOME/src/xdelta3
BIN_ZIPADJUST=$HOME/src/zipadjust

FILE_MATCH=LiteOS-*.zip
PATH_CURRENT=$HOME/../out/target/product/$DEVICE
PATH_LAST=$HOME/prebuilt/last/$DEVICE

KEY_X509=$HOME/../build/make/target/product/security/platform.x509.pem
KEY_PK8=$HOME/../build/make/target/product/security/platform.pk8
